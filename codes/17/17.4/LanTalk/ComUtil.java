...
public class ComUtil
{
	...
	// 定义多点广播所用的DatagramSocket实例
	private DatagramSocket socket = null;
	// 定义本程序私聊的DatagramSocket实例
	...
	public ComUtil(LanTalk lanTalk) throws Exception
	{
		...
		// 设置多点广播所使用的网络接口
		socket.setOption(StandardSocketOptions.
			IP_MULTICAST_IF, netInterface);
				...
				try
				{
						...
						&& msg.endsWith(YeekuProtocol.PRESENCE))
					{
						...
						String[] userInfo = userMsg.split(YeekuProtocol
							.SPLITTER);
						var user = new UserInfo(userInfo[1],
