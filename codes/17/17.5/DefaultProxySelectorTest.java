...
public class DefaultProxySelectorTest
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		props.setProperty("https.proxyHost", "192.168.10.97");
		...
		props.setProperty("ftp.proxyHost", "192.168.10.98");
		...
		props.setProperty("socks.ProxyHost", "192.168.10.99");
